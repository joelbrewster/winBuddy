...
- (void)mf_updateBorder {
    NSWindow *borderWin = objc_getAssociatedObject(self, borderKey);
    [borderWin.contentView setBorderColor:self.isKeyWindow ? [NSColor colorWithRed:.24 green:.57 blue:.92 alpha:1] : [NSColor colorWithRed:.14 green:.14 blue:.14 alpha:1]];
